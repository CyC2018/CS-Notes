...
网上有很多相关的资料，但是这些资料都比较零散。本仓库的笔记是从经典的书籍和材料中整理而来，在整理出重点的同时会尽可能保证知识的系统性，因此比较适合作为应对面试的学习资料。笔记内容不是简单的对网上的材料进行复制粘贴，而是一个字一个字从书上整理而来。当然也有小部分内容参考了网上的材料，但是有先对这部分内容的语言逻辑以及排版进行了修改。
