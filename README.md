...
牛客网上有很多优质面经，面经往往会给出一些面试需要准备的知识列表，但是这些知识列表都很零散，不适合系统地进行学习。为此，楼主选取了一些计算机经典书籍和材料，整理了一份面向面试的学习笔记，希望对大家有所帮助。
...
之后会继续整理其它方面的笔记，例如 Java、数据库、系统设计等，可能也会整理一些编码实践相关的笔记，例如重构、代码风格。
